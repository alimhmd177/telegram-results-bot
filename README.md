# 🤖 بوت تليجرام لمراقبة صفحة النتائج وجلب النتائج

بوت تليجرام ذكي يراقب صفحة نتائج الطلاب تلقائياً ويرسل إشعارات فورية عندما تصبح متاحة، **بالإضافة إلى جلب نتيجة الطالب مباشرة عند إدخال الرقم الجامعي!**

## ✨ المميزات

- ✅ مراقبة تلقائية 24/7 للموقع
- ✅ إشعارات فورية على تليجرام عند توفر الموقع
- ✅ **جلب النتيجة مباشرة بإرسال الرقم الجامعي**
- ✅ تسجيل دخول تلقائي بكلمة مرور ثابتة
...
#### لمراقبة الموقع:
1. أرسل: `/monitor`
2. ستتلقى إشعاراً فورياً عندما يصبح الموقع متاحاً
...
| **إرسال رقم جامعي** | **جلب النتيجة مباشرة** 🎓 |

---

## 🎯 كيفية الحصول على نتيجتك

**الطريقة الأسهل:**
1. افتح البوت على تليجرام
2. أرسل رقمك الجامعي فقط (مثال: `12345`)
3. سيقوم البوت بـ:
   - تسجيل الدخول تلقائياً بكلمة المرور الثابتة (123456)
   - جلب نتيجتك
   - إرسالها لك خلال ثوانٍ
...
📊 النتائج:
• المادة: الرياضيات | الدرجة: 85 | التقدير: جيد جداً
• المادة: البرمجة | الدرجة: 90 | التقدير: ممتاز
...
| `DEFAULT_PASSWORD` | كلمة المرور الثابتة | `123456` |
...
- تأكد من صحة الرقم الجامعي
- تحقق من أن الموقع متاح (استخدم `/status`)
- تأكد من أن كلمة المرور الافتراضية صحيحة
- قد تكون النتائج غير منشورة بعد

---

## 🔒 الأمان والخصوصية

- ✅ البوت لا يحفظ أي بيانات
- ✅ كلمة المرور ثابتة ومشفرة في الكود
- ✅ جميع الطلبات مباشرة للموقع
- ✅ لا يتم تخزين النتائج
